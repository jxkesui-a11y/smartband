<template>
        <div class="max-w-4xl mx-auto flex flex-col gap-6 animate-in slide-in-from-top-4 duration-500">
...
const { pendingUsers, declineUser, approveUser } = inject('smartband');
</script>